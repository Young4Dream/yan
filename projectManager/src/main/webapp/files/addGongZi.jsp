...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >工资信息录入</th>
  </tr>
  <tr>
    <td class="CPanel">
		...
		<TR>
			<TD width="100%">
				...
				<legend>工资信息</legend>
					  ...
					  <tr>
					    <td nowrap align="right" width="13%">工资类型:</td>
				        ...
				        *</span></td>
					    <td align="right" width="19%">工资金额:</td>
					    <td width="35%"><span class="red">
				        <input name='txt342222' type="text" class="text" style="width:154px" value=""/>
				        *</span></td>
					    </tr>
					  ...
					  <tr>
					    ...
					    <td colspan="3"><textarea name="textarea2" cols="105" rows="20"></textarea></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
