									...
									<fieldset style="height:100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												...
												<td width="46%"><input name="text" class="text"
													style="width:300px" type="text" size="40" /> <span
													class="red"> *</span>
												</td>
											...
											<tr>
												...
												<td colspan="3"><textarea id="" name="" rows="5"
														cols="80"></textarea></td>
											</tr>
										</table>
										<br />
									...
									<fieldset style="height:100%;">
										...
										<table border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												<td nowrap align="right" height="120px">需求描述:</td>
												<td colspan="3"><textarea id="" name="" rows="5"
														cols="80"></textarea> <textarea id="textarea2"
														name="textarea2" rows="5" cols="80"></textarea>
												</td>
											</tr>
										</table>
										<br />
