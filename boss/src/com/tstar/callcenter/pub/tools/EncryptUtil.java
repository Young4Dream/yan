...
public class EncryptUtil {
	...
	//绝对位置
	//public static String key = (String) PropertiesUtil.getProperties("/usr/local/tomcat/webapps/callcenter/WEB-INF/classes/config/key.properties").get("key");
	 ...
	 * 功能描述:经过封装的DES/CBC加密算法，如果包含中文，请注意编码。
	...
	/**
	 * 方法名称:MD5Hash
	 * 功能描述:MD5，进行了简单的封装，以适用于加，解密字符串的校验。
	 * 
	...
	/**
	 * 方法名称:addMD5
	 * 功能描述: MD校验码 组合方法，前16位放MD5Hash码。 把MD5验证码byte[]，加密内容byte[]组合的方法。
	 * 
