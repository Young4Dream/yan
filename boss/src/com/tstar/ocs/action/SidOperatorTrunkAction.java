...
public class SidOperatorTrunkAction extends ActionSupport {
	private static final long serialVersionUID = 1L;
	
	@Resource
	private SidOperatorTrunkService service;
	
	private String id;
	private String fk;
	private SidOperatorTrunk obj;
	private List<SidOperatorTrunk> lst;
	...
	public void setObj(SidOperatorTrunk obj) { this.obj = obj; }
	public SidOperatorTrunk getObj() { return obj; }
	
	public void setLst(List<SidOperatorTrunk> lst) { this.lst = lst; }
	public List<SidOperatorTrunk> getLst() { return lst; }
	...
	public String findByFk() {
		if (fk == null || "".equals(fk)) {
			lst = new ArrayList<SidOperatorTrunk>();
		} else {
