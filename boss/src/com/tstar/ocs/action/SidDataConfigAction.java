...
public class SidDataConfigAction extends ActionSupport {
	private static final long serialVersionUID = 1L;
	
	@Resource
	private SidDataConfigService service;
	
	private String id;
	private SidDataConfig obj;
	private List<SidDataConfig> lst;
	...
	public void setObj(SidDataConfig obj) { this.obj = obj; }
	public SidDataConfig getObj() { return obj; }
	
	public void setLst(List<SidDataConfig> lst) { this.lst = lst; }
	public List<SidDataConfig> getLst() { return lst; }
