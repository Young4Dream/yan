									...
									<ul class="nav nav-tabs">
										<li class="active">
							 				<a href="#panel-7" data-toggle="tab">
							 					<i class="blue icon-resize-vertical bigger-110"></i>
							 					电话调级
							 				</a>
										</li>
										<li>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="panel-7">
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<select class="form-control" id="oldPhoneLevel" role="option" disabled="disabled">
													</select>
												</div>
					 							<label for="newPhoneLevel" class="col-sm-1 control-label">新级别</label>
												<div class="col-sm-3">
													<select class="form-control" id="newPhoneLevel" role="option">
													</select>
												</div>
											</div>
										</div>
