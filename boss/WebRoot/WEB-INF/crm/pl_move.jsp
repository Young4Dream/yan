...
<html>
	...
	<body>
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="panel-7">
											<div class="row form-group">
					 							<label for="phoneNo" class="col-sm-1 control-label">专线编号</label>
												<div class="col-sm-3">
													<div class="input-group">
													<input id="userId" type="hidden"/>
													<input class="form-control" id="businessKey" type="text" placeholder="（输入专线编号）查询"/>
											...
											<div class="row form-group">
					 							<label for="newUserAddress" class="col-sm-1 control-label">现地址</label>
												<div class="col-sm-7">
													<input class="form-control" id="newUserAddress" type="text" placeholder="请输入新安装地址"/>
												</div>
											</div>
										</div>
										<!-- 客户信息 -->
										...
										<div class="tab-pane" id="panel-3">
											<div class="row form-group">
												...
												<div class="col-sm-3">
					 							...
					 							<label for="businessKey1" class="col-sm-1 control-label">专线号</label>
												<div class="col-sm-3">
													<input class="form-control" id="businessKey1" type="text"/>
												</div>
					 							<label for="plType" class="col-sm-1 control-label">专线类型</label>
												<div class="col-sm-3">
													<select class="form-control" id="plType">
													</select>
												</div>
											</div>
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" id="plModel" type="text"/>
												</div>
					 							<label for="userName" class="col-sm-1 control-label">用户名称</label>
												<div class="col-sm-3">
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" id="startEp" type="text"/>
												</div>
					 							<label class="col-sm-1 control-label">终止端点</label>
												<div class="col-sm-3">
													<input class="form-control" id="endEp" type="text"/>
												</div>
		...
		var parentProductId = "l"; // Used by product.js
		var businessType = "l";
		var opType = "move";
