								...
								<div class="tabbable" id="tabtable1">
									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="panel-7">
											...
											<div class="row form-group">
					 							<label for="newBusinessKey" class="col-sm-1 control-label">现账号</label>
												<div class="col-sm-3">
													<input class="form-control" id="newBusinessKey" type="text" placeholder="请输入新账号"/>
												</div>
					 							<label for="newOutVlan" class="col-sm-1 control-label">现VLAN</label>
												<div class="col-sm-3">
													<input class="form-control" id="newOuterVlan" type="text" placeholder="请输入新账号"/>
												</div>
					 							<label for="newBusinessArea" class="col-sm-1 control-label">现区域</label>
												<div class="col-sm-3">
										...
										<div class="tab-pane" id="panel-3">
											<div class="row form-group">
												...
												<div class="col-sm-3">
					 							...
					 							<label for="businessKey1" class="col-sm-1 control-label">上网账号</label>
												<div class="col-sm-3">
