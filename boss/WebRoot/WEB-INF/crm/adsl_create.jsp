	...
	<body>
									...
									<div class="tab-content">
										...
										<div class="tab-pane" id="panel-3">
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" id="phoneNo" type="text" placeholder="输入绑定电话，自动生成账号和密码"/>
												</div>
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<input class="form-control" id="userAddress" type="text" placeholder="选择安装地址，自动获取VLAN和区域信息"/>
												</div>
        ...
        $(document).ready(function () {
       	...
       	$("#phoneNo").change(function(){
       		var parm = { "id": $("#phoneNo").val() };
       		var res = ajaxCRUD("crmUser!findFullInfoByBusinessKey.do", parm, false);
       		var user = res.userFullInfo;
       		if (user == undefined || user == null) {
       			bbAlert("电话用户" + $("#phoneNo").val() + "不存在");
       			$("#phoneNo").focus();
       			return;
       		}
       		$("#userPwd").val($("#phoneNo").val());
       		$("#acc").val("ADSL" + $("#phoneNo").val());
       		
			$("#userName").val(user.name);    
			$("#userDepartmentId").val(user.departmentId);    
			$("#userDepartmentName").val(user.departmentName);
			$("#payPolicy").val(user.payPolicy);
			$("#postAddress").val(user.address);    
        ...
        $("#userAddress").focus(function() {
        	fnAddressChoosed = function(address, vlan, accPrefix, businessArea, userArea){
