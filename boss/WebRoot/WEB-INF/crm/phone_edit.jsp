	...
	<body>
										...
										<div class="tab-pane active" id="panel-3">
											<div class="row form-group">
												...
												<div class="col-sm-3">
													...
													<input class="form-control" id="phoneNo" type="text" placeholder="（输入号码）查询"/>
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<select class="form-control" id="deviceCode" disabled="disabled">
											...
											<div class="row form-group">
												...
												<div class="col-sm-3">
													<select class="form-control" id="phoneLevel" disabled="disabled">
													</select>
												</div>
        ...
        $("#save").click(function() {
        	...
        	var parm = {
        		...
        		"user.phoneAlias" : $("#phoneAlias").val(),
