	...
	<body>
					...
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-xs-9">
									<input type="text" id="itemName" class="form-control" placeholder="请输入账目名称"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding">
								...
								<div class="col-xs-9">
									<input type="text" id="itemCode" class="form-control" placeholder="请输入账目编号"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 control-label no-padding">账目描述：</label>
								<div class="col-xs-9">
			...
			if (node == undefined) return;
	   		bootbox.confirm({
				...
				callback: function(result){
	   				if(result){
						var parm = {"obj.itemCode": node.code };
					    var resData = ajaxCRUD("sysAccountItem!deleteByCode.do", parm, true);
						if(resData.resNum == "0"){
        ...
        $("#save").click(function() {
        	...
        	if (flag == "add") {
        		...
        		url = "sysAccountItem!insert.do";
        	} else {
        		itemCode = $("#itemCode").val();
        		url = "sysAccountItem!update.do";
        	}
        	var parm = {
    			"obj.id": $("#id").val(),
