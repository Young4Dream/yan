                    ...
                    <div class="col-sm-12 no-padding-left tablesearch">
                        <div class="col-sm-12" style="padding-bottom: 5px;">
                            ...
                            <div class='col-sm-6'>
                                ...
                                <select name="roleInfo.isAdmin" calss="input-sm" id="seAdmin">
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                <button type="submit" id="search" class="btn btn-sm btn-primary pull-right">
                                    查询
                                </button>
                            </div>
                            <div class="col-sm-6">
                                <button type="submit" id="addbutton" class="btn btn-sm btn-primary pull-left">
                                    添加
                                </button>
                            </div>
                        </div>
                    ...
                    <table class="modal-table" cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            ...
                            <tr rowpos="2" class="FormData" id="">
                                ...
                                <td class="DataTD">
                                    <select name="roleInfo.isAdmin" calss="input-sm" id="modalisAdmin" style="position:relative;left:-3px;">
                                        <option role="option" value="1">
                                            是
                                        </option>
                                        <option role="option" value="-1">
...
<script src="assets/js/jquery.dataTables.min.js"></script>
 -->
        ...
        oTable1 = $('#sample-table-2').dataTable({
            ...
            columnDefs: [{
                    ...
                    render: function(a, b, c, d) {
                        var context = {
                            func: [{
                                "fn": "detailWindow(" + c.roleid + ",\'" + c.rolename + "\'," + c.isadmin + ",\'" + c.remark + "\',\'" + c.createtime + "\')",
                                "color": "blue",
                                "icon": "zoom-in"
                            }, {
                                "fn": "updateWindow(" + c.roleid + ",\'" + c.rolename + "\'," + c.isadmin + ",\'" + c.remark + "\',\'" + c.createtime + "\')",
                                "color": "red",
                                "icon": "pencil"
                            }, {
                                "fn": "del(" + c.roleid + ")",
    ...
    function updateWindow(id, name, isAdmin, remark, createTime) { //弹出修改模态框
    ...
    function detailWindow(id, name, isAdmin, remark, createTime) { //弹出查看详细信息模态框
    ...
    function conf(id, onReady) {
        ...
        var resData = ajaxCRUD("role!check.do", params, false); //url，参数，是否弹出alert
    ...
    function fromSubmin(url) {
        ...
        var params = {
            "roleInfo.roleId": rid,
            "roleInfo.roleName": rname,
            "roleInfo.isAdmin": radmin,
            "roleInfo.remark": rremark,
            "roleInfo.createTime": rct
        };
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        var resData = ajaxCRUD("role!delete.do", params, true); //url，参数，是否弹出alert
                        if (resData.resNum != 0) {
                            window.parent.updateRole();
                            oTable1.fnSettings().ajax.data = {}; // 定义dataTable初始参数
                            oTable1.api().ajax.reload();
