...
public class OrclSqlSessionFactoryUtil {
	
	private static SqlSessionFactory sqlSessionFactory=null;
	private static final Class<OrclSqlSessionFactoryUtil> CLASS_LOCK=OrclSqlSessionFactoryUtil.class;
	/**
	 * 私有化构造参数
	 */
	private OrclSqlSessionFactoryUtil(){};
	
	public static SqlSessionFactory initSqlSessionFactory(){
		String xmlResource="orcl-mybatis-config.xml";
...
//						System.out.println(decUsername+decPassword);
			...
			Logger.getLogger(OrclSqlSessionFactoryUtil.class.getName()).log(Level.SEVERE, null,e);
		}
